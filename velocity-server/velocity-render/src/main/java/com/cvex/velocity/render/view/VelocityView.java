...
public class VelocityView extends AbstractTemplateView {
    ...
    protected VelocityEngine autodetectVelocityEngine() throws BeansException {
        try {
            Assert.notNull(getApplicationContext(), "Application Context is not provided");

            VelocityEngineFactoryBean velocityConfig = BeanFactoryUtils.beanOfTypeIncludingAncestors(
                    getApplicationContext(), VelocityEngineFactoryBean.class, true, false);
            return velocityConfig.getObject();
     ...
     * @see #initTool
     * @see com.cvex.velocity.render.context.ChainedContext
     * @see VelocityToolboxView
     */
